...
from .vitb16_detector import Vitb16Detector
from .sta_detector import StACLIPDetector
from .xclip_srm_detector import XCLIPSRMDetector
from .clip2_detector import CLIP2Detector
from .clip_detector_srm import CLIPSRMDetector
from .clip3_detector import CLIP3Detector
from .effort_detector import EffortDetector
from .clip_aaai import CLIPAAAIDetector
from .clip_aaai_f2 import CLIPDeepFakeDetector